...
Dokumen ini berisi rancangan skenario pengujian fungsional menggunakan metode **Black Box Testing** dan pengujian penerimaan pengguna menggunakan metode **User Acceptance Testing (UAT)** untuk aplikasi **Koperasi Karya Tantri Abadi**.
