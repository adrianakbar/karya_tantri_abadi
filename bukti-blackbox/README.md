...
| 09-spv-dashboard.png | Dashboard SPV |
| 10-spv-loans.png | Daftar pinjaman SPV |
| 11-kasir-dashboard.png | Dashboard kasir |
...
| 15-anggota-dashboard.png | Dashboard/panel anggota |
...
## Dipakai untuk
- BAB 4 Hasil dan Pembahasan (Gambar 4.x)
- Lampiran bukti pengujian Black Box
- Pendukung demo/UAT
